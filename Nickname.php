<HTML>
<HEAD>
<TITLE>Team Nicknames History</TITLE>
...
<h2>Team Nicknames History</h2>
The file linked below is comma delimited. For the current teams, it contains the history
of their locations, leagues/divisions, and commonly used nicknames.
<p>
The fields are:
<p>
Current franchise ID<br>
Franchise ID (may the same as current one) for earlier data<br>
League<br>
Division (blank before divisional play)<br>
Location name (e.g. Brooklyn, Texas)<br>
Nickname<br>
Alternate nicknames (blank if none for the period)<br>
Date of the first game with this combination<br>
Date of the last game with combination (blank if current one)<br>
City<br>
State<br>
<p>
The league codes are:
<p>
NA = National Association<br> 
NL = National League<br>
AA = American Association<br> 
AL = American League<br>
<p>
Posting history:
<br>4/27/2010: First release
<br>5/2/2010: Added A's (Athletics alternate), modified Pittsburgh in 1880s, 1890s)
<br>5/3/2010: A few modifications to data for 1961-2009

<p>
<a href="https://www.retrosheet.org/CurrentNames.csv">Team Nicknames File</a>

<p>The Franchise Directory contains teams' annual won-lost records, standings, managers, and
other data: 
<a href="https://www.retrosheet.org/boxesetc/MISC/FRDIR.htm">Franchise Directory</a>

<hr>
<P align=center>Page Updated: 12/20/2015</P>
<P align=center>All data contained at this site is copyright © 1996-2015 by
